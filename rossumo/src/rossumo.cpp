...
protected:
  ...
  void cmd_vel_cb(const geometry_msgs::TwistConstPtr & msg) { set_speeds(msg->linear.x*14, -msg->angular.z*7); }

  //////////////////////////////////////////////////////////////////////////////

  void cmd_vel_norm_cb(const geometry_msgs::TwistConstPtr & msg) {
    int v, w;
    speeds2ticks(msg->linear.x, msg->angular.z*7, v, w);
    ROS_INFO_THROTTLE(1, "cmd_vel_norm_cb(%g, %g)->(%i, %i)", msg->linear.x*14, msg->angular.z*7, v, w);
    set_speeds(v, w);
  }
